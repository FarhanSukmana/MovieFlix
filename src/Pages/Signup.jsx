...
const Signup = () => {
  ...
  return (
    ...
    <div className='w-full h-screen'>
      <img className='hidden sm:block absolute w-full h-full object-cover' src="https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&q=80&w=1459&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
      alt="" />
      ...
      <div className='fixed w-full px-4 py-24 z-50'>
        <div className='max-w-[350px] h-[500px] bg-black/80 mx-auto text-white '>
            ...
            <form onSubmit={btnSubmit} className='flex flex-col p-6 pt-12 '>
              ...
              className='px-2 py-2 focus:outline-none bg-gray-700' type="email" placeholder='Masukan Email' />
              </div>
            ...
            <div className='mt-14'>
              <p className='text-gray-700 pl-4'>Sudah Memiliki Akun?
                <span>
                  <Link to='/login' className='pl-2 text-white'>Login</Link>
                </span>
              </p>
            </div>
        </div>
